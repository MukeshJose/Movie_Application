...
public class SimilarAdapter extends RecyclerView.Adapter<SimilarAdapter.MyViewHolder> {
    ...
    public SimilarAdapter(Context context, Root root) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Glide.with(context).load(Constants.baseUrlImage + root.results.get(position).poster_path).into(holder.similarImage);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            similarImage = itemView.findViewById(R.id.moviePoster);
        }
    }
}
