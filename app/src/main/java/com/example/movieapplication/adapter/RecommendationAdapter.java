...
public class RecommendationAdapter extends RecyclerView.Adapter<RecommendationAdapter.MyViewHolder> {
    ...
    public RecommendationAdapter(Context context, Root root) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Glide.with(context).load(Constants.baseUrlImage + root.results.get(position).poster_path).into(holder.recoImage);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            recoImage = itemView.findViewById(R.id.moviePoster);
        }
    }
}
